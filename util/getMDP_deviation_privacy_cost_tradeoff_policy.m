function [policy_all_partitions] = getMDP_deviation_privacy_cost_tradeoff_policy(evalCacheParams)
...
for tradeOff_sigma_forcost_idx = 2:num_tradeoffs-1
    ...
    policy_all_partitions{:,tradeOff_omega_withinUtility_idx,tradeOff_sigma_forcost_idx} = getMDP_deviation_cost_tradeoff_policy(evalCacheParams_t);
end
...
for tradeOff_sigma_forcost_idx = 2:num_tradeoffs-1
    ...
    evalCacheParams_t.tradeOff_omega_withinUtility_idx = tradeOff_omega_withinUtility_idx;
    evalCacheParams_t.tradeOff_sigma_forcost_idx = tradeOff_sigma_forcost_idx;
    policy_all_partitions{:,tradeOff_omega_withinUtility_idx,tradeOff_sigma_forcost_idx} = getMDP_privacy_cost_tradeoff_policy(evalCacheParams_t);
end
end
