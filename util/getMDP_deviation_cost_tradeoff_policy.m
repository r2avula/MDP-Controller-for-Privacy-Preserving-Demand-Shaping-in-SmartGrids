function [policy_all_partitions] = getMDP_deviation_cost_tradeoff_policy(evalCacheParams)
...
for partition_idx = 1:deglifePartitions_num
    ...
    if(fileExists)
        ...
        valueFuncation_kp1 = zeros(z_num,controller_x_num,h_num,controller_y_num);
        ...
        for horizon_idx = timeHorizonsPerDay:-1:1            
            for k_in_horizon = k_num_in_horizon:-1:1
                ...
                controllerDecisions_k = zeros(z_num,controller_x_num,h_num,controller_y_num);
                valueFunction_k = zeros(z_num,controller_x_num,h_num,controller_y_num);
                opt_start = tic;                
